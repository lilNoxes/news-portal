...
import { Newspaper, Search, Moon, Sun, X, Bookmark, ShieldCheck, Lock } from 'lucide-react';
          ...
          <div className="flex items-center gap-2">
            ...
            {isAdmin ? (
              <button
                ...
                className="flex items-center gap-1.5 px-3 py-2 rounded-xl bg-emerald-500 hover:bg-emerald-600 text-white text-xs font-semibold shadow-sm shadow-emerald-500/20 transition active:scale-95"
              >
              ...
              <button
                ...
                className="p-2 rounded-xl border border-slate-200 dark:border-slate-800 text-slate-500 dark:text-slate-400 hover:text-sky-500 hover:border-sky-300 dark:hover:border-sky-800 hover:bg-slate-100 dark:hover:bg-slate-800 transition"
              >
