...
export default function AboutModal({ isOpen, onClose }) {
  ...
  const sources = [
    ...
    { name: 'The Guardian (World)', desc: 'Ведущее международное независимое издание Великобритании', category: 'В мире' },
    { name: 'Al Jazeera (World)', desc: 'Международная повестка и глобальные мировые события', category: 'В мире' },
    { name: 'Lenta.ru (Мир)', desc: 'Оперативная картина ключевых мировых и геополитических событий', category: 'В мире' },
    ...
    { name: 'TechCrunch / The Verge', desc: 'Мировые технологические тренды, венчур и стартапы', category: 'Технологии' },
    ...
    { name: 'N+1 / Ars Technica', desc: 'Научные открытия, биотех и фундаментальные исследования', category: 'Наука' }
  ];
